...
def make_a_prompt():
    ...
    if input_mode:
        ...
        print(
            ' example done this: "you have used mathematics and code to find primes using higher level geometry."'
        )
        ...
        DURATION = input(
            "how long has the bot been {}: (if applicable) ".format(DONE_THIS)
        )
        print("-" * 50)
        ...
        print("-" * 50)
        print(
            ' example constraint: "you must always ask questions before you answer so you can better hone in on what the questioner is looking for"'
        )
        ...
        print("-" * 50)
        print(
            ' example requirements: "you must be able to answer questions and respond with appropriate and applicable feedback to the mans comments."'
        )
        REQUIREMENTS = input(
            "what are the requirements that the model must have to accomplish the task: "
        )
        print("-" * 50)
        print(
            ' example action: "craft a prompt that makes chatGPT able to accomplish the goal: {}"'.format(
                GOAL
            )
        )
        ...
        # print("-" * 50)
        print(
            ' example critical instructions: "you must be able to answer questions and respond with appropriate and applicable feedback to the mans comments."'
        )
        critical_instructions = input(
            "what are the critical instructions that the model must have to accomplish the task: "
        )
        print("-" * 50)
    else:
    ...
    REFERENCE MATERIALS (DO NOT REPLICATE THIS MATERIAL IN YOUR PROMPT):
        ...
        REFERENCE 2. THE PROMPT GENERATOR'S GUIDE:
            ...
            * note: in this section `session` refers to the chatGPT session that is generated from `prompt_beta` (emulating a {bot_type}) *
            ...
            CONSTRAINT3 = The constraints that the session must follow are {CONSTRAINT} and {CONSTRAINT2}.
